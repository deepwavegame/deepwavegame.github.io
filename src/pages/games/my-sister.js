      ...
      <main style={{ backgroundColor: '#111111', color: '#d2d2d2', minHeight: '100vh', paddingBottom: '4rem' }}>
        ...
        <header className="hero mystery-bg" style={{ minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <h2 style={{ color: '#aaa', fontWeight: 'normal', letterSpacing: '1px' }}>
            <Translate id="games.my-sister.subtitle">MY SISTER</Translate>
          </h2>
          ...
          <section className="row" style={{ marginBottom: '4rem' }}>
            <div className="col col--8 col--offset-2">
              ...
              <div className="unity-card" style={{ fontSize: '1.2rem', lineHeight: '1.8' }}>
                <p>
                  <Translate id="games.my-sister.story.p1">
                ...
                <p>
                  <Translate id="games.my-sister.story.p2">
                ...
                <p style={{ color: '#ff3333', fontStyle: 'italic', marginTop: '2rem', textAlign: 'center' }}>
                  <Translate id="games.my-sister.story.quote">"You promised never to leave me..."</Translate>
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="row">
                <div className="col col--4">
                  <div className="unity-card" style={{ height: '100%' }}>
                    <h3><Translate id="games.my-sister.feature1.title">Haunting Graphics</Translate></h3>
                    <p><Translate id="games.my-sister.feature1.desc">Using advanced lighting technology on Unity HDRP, bringing a realistic and dark atmosphere to the point of suffocation.</Translate></p>
                  </div>
                </div>
                <div className="col col--4">
                  <div className="unity-card" style={{ height: '100%' }}>
                    <h3><Translate id="games.my-sister.feature2.title">Spatial Audio</Translate></h3>
                    <p><Translate id="games.my-sister.feature2.desc">3D spatial audio system allows you to clearly hear every footstep or breath of the force hunting you.</Translate></p>
                  </div>
                </div>
                <div className="col col--4">
                  <div className="unity-card" style={{ height: '100%' }}>
                    <h3><Translate id="games.my-sister.feature3.title">Psychological Puzzles</Translate></h3>
                    <p><Translate id="games.my-sister.feature3.desc">Not just running away, you need to find out and piece together memories through a puzzle system based on supernatural phenomena.</Translate></p>
                  </div>
                </div>
              </div>
            </div>
